...
// trash items
const trash = [['Nothing special here... Just wasted items.'],
  ['A stinky socket...'], ['You found a rare Pokémon card here!'],
  ['You found a coin! You have one more now!'],
['Empty buttle.'], ['Crumpled paper...']]
...
export const interactionWithTrashBin = (player, k, map) => {
  ...
  player.onCollide('trash_bin_lobby', () => {
    ...
    if (trash[randomTrash][0] == 'You found a coin! You have one more now!') {
