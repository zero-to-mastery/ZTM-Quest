    ...
    const questions = [
        {
            ...
            answer: 'A',
            explanation:
                "In JavaScript, adding a number and a string results in string concatenation, so 2 + '2' gives '22'.",
        },
        {
        ...
        },
        {
            ...
            answer: 'B',
            explanation:
                "The correct syntax to define a function is 'function myFunction()'.",
        },
        {
            ...
            answer: 'A',
            explanation:
                "You create an array in JavaScript using square brackets: var colors = ['red', 'green'];",
        },
        {
        ...
        },
        {
            ...
            answer: 'C',
            explanation:
                'Both parseInt() and Number() can convert a string to a number.',
        },
        {
